...
variable "test_runtime" {
  description = "Orchestrator runtime the environment is built on."
  type        = string
}
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"aria_orchestrator_environment.test", "name", "ARIA_PROVIDER_TEST",
					),
					resource.TestCheckResourceAttr(
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"aria_orchestrator_environment.test", "name", "ARIA_PROVIDER_TEST_RENAMED",
					),
					resource.TestCheckResourceAttr(
						"aria_orchestrator_environment.test", "description",

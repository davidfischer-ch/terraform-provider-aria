...
resource "aria_abx_action" "create" {
  name            = "ARIA_PROVIDER_TEST_CR_CREATE"
...
resource "aria_abx_action" "read" {
  name            = "ARIA_PROVIDER_TEST_CR_READ"
  description     = "Temporary action generated by Aria provider's acceptance tests."
  runtime_name    = "python"
  memory_in_mb    = 128
  timeout_seconds = 60
...
resource "aria_abx_action" "update" {
  name            = "ARIA_PROVIDER_TEST_CR_UPDATE"
  description     = "Temporary action generated by Aria provider's acceptance tests."
  runtime_name    = "python"
  memory_in_mb    = 128
  timeout_seconds = 60
...
resource "aria_abx_action" "delete" {
  name            = "ARIA_PROVIDER_TEST_CR_DELETE"
  description     = "Temporary action generated by Aria provider's acceptance tests."
  runtime_name    = "python"
  memory_in_mb    = 128
  timeout_seconds = 60
...
resource "aria_custom_resource" "test" {
  ...
  resource_type = "Custom.ARIA_PROVIDER_TEST.TestCR"

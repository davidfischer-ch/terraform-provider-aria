...
resource "aria_orchestrator_workflow" "test" {
  name        = "ARIA_PROVIDER_TEST_WORKFLOW"
    ...
    postcondition {
      ...
      error_message = "Attribute Input Forms is not what we expected: ${self.input_forms}"
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aria_orchestrator_workflow.test", "name", "ARIA_PROVIDER_TEST_WORKFLOW"),
...
resource "aria_orchestrator_workflow" "test" {
  name        = "ARIA_PROVIDER_TEST_WORKFLOW_RENAMED"
  ...
  lifecycle {
    postcondition {
      ...
      error_message = "Attribute Input Forms is not what we expected: ${self.input_forms}"
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet("aria_orchestrator_workflow.test", "id"),
					resource.TestCheckResourceAttr("aria_orchestrator_workflow.test", "name", "ARIA_PROVIDER_TEST_WORKFLOW_RENAMED"),

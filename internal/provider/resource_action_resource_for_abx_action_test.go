...
func TestAccResourceActionForABXActionResource(t *testing.T) {
...
`,
			...
			// Form from JSON string manually encoded
			{
				Config: `
variable "test_project_id" {
  description = "Project where to generate test resources."
    ...
    form = <<-EOT
  {
    ...
    "schema": {
        "dotNetRuntimeVersion": {
            "label": "Version .NET Runtime à installer",
            "type": {
                "dataType": "string"
            },
            "valueList": [
                {
                    "label": "8.0.7",
                    "value": "8.0.7.33813",
                    "description": "ZZ Version 8.0.7.33813"
                },
                {
                    "label": "7.0.5",
                    "value": "7.0.5.32324",
                    "description": "Version 7.0.5.32324"
                },
                {
                    "label": "6.0.32",
                    "value": "6.0.32.33814",
                    "description": "Version 6.0.32.33814"
                },
                {
                    "label": "6.0.16",
                    "value": "6.0.16.32323",
                    "description": "Version 6.0.16.32323"
                }
            ],
            "placeholder": ".NET Runtime version",
            "constraints": {
                "required": true
            }
        }

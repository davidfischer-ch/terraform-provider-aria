...
resource "aria_orchestrator_workflow" "test" {
  name        = "ARIA_PROVIDER_TEST_WORKFLOW_FOR_CS"
...
`,
			...
			// Update, use Workflow's integration attribute and Read testing
			{
				Config: `
			resource "aria_orchestrator_category" "root" {
			  name      = "ARIA_PROVIDER_TEST"
				...
				workflows = [
				  {
					...
					description = aria_orchestrator_workflow.test.description
					version     = aria_orchestrator_workflow.test.version
					integration = aria_orchestrator_workflow.test.integration
				  }
				]
			  }
